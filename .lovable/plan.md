...
2. **Collisions** — four spreadsheets:
   - `collision-athletics-domains.csv`: any athletics domain attached to two or more different schools, with every school on it.
   - `collision-page-urls.csv`: any roster or staff page used by two or more different programs.
