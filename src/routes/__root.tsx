...
import { CompareProvider } from "@/components/compare/compare-selection";

function NotFoundComponent() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-chalk px-4">
      <div className="max-w-md text-center">
        <h1 className="font-display text-7xl font-bold text-org-primary">404</h1>
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="touch-target inline-flex items-center justify-center rounded-md bg-seam-red px-4 text-sm font-semibold text-white transition-colors hover:bg-seam-red/90"
          >
            Go home
          </Link>
        </div>
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      {/* Compare selections must survive navigation between search and profiles. */}
      <CompareProvider>
