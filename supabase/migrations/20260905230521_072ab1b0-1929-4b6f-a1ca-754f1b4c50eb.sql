...
CREATE OR REPLACE FUNCTION public.collection_cron_unschedule()
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
...
REVOKE ALL ON FUNCTION public.collection_cron_unschedule() FROM PUBLIC, anon, authenticated;
REVOKE ALL ON FUNCTION public.trigger_collection_runner() FROM PUBLIC, anon, authenticated;
REVOKE ALL ON FUNCTION public.collection_cron_start() FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.collection_cron_stop() FROM PUBLIC, anon;
